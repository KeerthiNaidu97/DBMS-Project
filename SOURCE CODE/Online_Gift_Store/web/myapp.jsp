				...
				<div class="header-right">
				 ...
				 <div class="top-nav">
					...
					<ul class="res" >
						...
						<li><a class="hvr-sweep-to-bottom" href="friend.jsp"></a></li>
						<li><a class="hvr-sweep-to-bottom" href="sendmsg.jsp"></a></li> 
	...
	<div class="container">
		<div class="gallery-main">
			<div class="gallery-top">
				<h3> My Added Gifts to Website</h3>
				<p>The list of my Added gifts in our website.</p>
			</div>
