...
String appicon=rs.getString(7);
                    ...
                    <tr>    <td align="center"><b>Gift ID</b></td>               <td align="center"><%=rs.getString("appid")%> </td>
                                  <tr> <td align="center"><b>GiftName</b></td>    <td align="center"><%=rs.getString("username")%> </td> </tr>   
                                 <tr>  <td align="center"><b>GiftName</b></td>    <td align="center"><%=rs.getString("appname")%></td> </tr>   
                                <input type="hidden" value="ApLi<%= (int) (Math.random() * 10000) %>no" name="licenseno" />
                                    
                                 <tr><td align="center"><b>Gift URL</b></td>    <td align="center"><input type="text" name="appurl" value="<%=rs.getString("appurl")%>" readonly="true"/> </td> </tr>   
                                   <tr> <td align="center"><b>Gift Icon</b></td>  <td align="center"><img src="apps/<%=rs.getString("appicon")%>"   width="200" height="200"/></td> </tr>   
     <input type="hidden" name="status" value="<%=rs.getString("status")%>" readonly="true"/>
                                  <tr> <td align="center"></td>   <td align="center">  <input type="submit" value="Gift Verification"/></td>
                                      </tr>  
