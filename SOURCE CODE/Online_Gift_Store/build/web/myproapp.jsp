	...
	<div class="container">
		<div class="gallery-main">
			<div class="gallery-top">
				<h3> My Profile Gifts</h3>
				<p>The list of Gifts Selected in my profile.</p>
			</div>
...
String appicon=rs.getString(7);
			   ...
			   <div class="col-md-4 view view-seventh">
                    ...
                    <div class="mask"> <a href="apps/<%=appicon%>" class="b-link-stripe b-animate-go  swipebox" width="200" height="200"  title="Image Title"></a><img src="apps/<%=appicon%>" alt="" width="100" height="100" class="img-responsive">
                        <h2><%=appname%></h2>                      
              
                   <br><br>
                    <span class="gall"> <a href="<%=appurl%>">View that Site</a></span>
