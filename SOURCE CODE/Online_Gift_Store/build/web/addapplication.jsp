...
<html>
<head>
<title>DOnline Gift Store</title>
							  ...
							  <center>
							                ...
							                <fieldset id="body">
							                          ...
							                          <input type="hidden" name="username"  value=<%=username%> />
                                                                                 <tr><td><fieldset>
							                          <label for="Application ID">Gift ID</label>
							                          <input type="text" name="appid"  id="appid">
                                                                                        </fieldset></td></tr>
                                                                                <tr><td><fieldset>
							                          <label for="Application Name">Gift Name</label>
							                          <input type="text" name="appname"  id="appname">
							                            ...
							                            <input type="text" name="accesstoken" id="accesstoken">
                                                                                  ...
                                                                                  <tr><td> <fieldset>
							                          <label for="Application URL">Gift URL</label>
							                ...
							                <input type="hidden" name="status"  value="No_License"/>
							                	 ...
							                	 <tr><td><fieldset>
							                          <label for="Application Icon">Gift Icon</label>
